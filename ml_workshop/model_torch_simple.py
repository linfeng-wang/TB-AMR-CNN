...
class raw_seq_model(nn.Module):
    ...
    def forward(self, x):
        ...
        # self.conv_layer1.weight.data.fill_(0.01)
        # torch.nn.init.xavier_uniform(self.conv1_layer1.weight)
        # torch.nn.init.uniform_(self.conv_layer1.weight)
        # torch.nn.init.uniform_(self.conv_layer1.bias)
